...
def run(Controller, MyCar, distanceData,left_c0,right_c0):
    """
    Control methord.
    ...
    # left_c0 = Com_getDoubleData(line_poly_info, 'roadLinesPolynomsArray[1]/c0')
    # right_c0 = Com_getDoubleData(line_poly_info, 'roadLinesPolynomsArray[2]/c0')
    Process_OutputLevel("left_c0 = {}".format(left_c0), 4)
    Process_OutputLevel("right_c0 = {}".format(right_c0), 4)
    MyCar.positionnow = -6.5 + left_c0 + right_c0
